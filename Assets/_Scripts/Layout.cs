...
public class Layout : MonoBehaviour {
    public PT_XMLReader             xmlr; // just like deck, this has a PT_xmlsreader
    ...
    // this holds all of the possible names for the layers set by laerID
    public string []                sortingLayerNames = new string [] { "Row0", "Row1", "Row2", "Row3", "Discard", "Draw" };

    public void ReadLayout(string xmlText) {   // this is a method
